...
global.anitav4 = process.env.BOT_NAME || "Tails-𝐕1.0";
global.ownername = process.env.OWNER_NAME || "Sean Phiri ";
global.packname = process.env.PACK_NAME || "Tails-V1.0 ";
global.author = process.env.AUTHOR || "Sean Phiri ";
global.channelname = process.env.CHANNEL_NAME || "Sean Phiri ";
global.channeljid = process.env.CHANNEL_JID || "none ";
